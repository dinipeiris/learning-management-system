...
<head>
    ...
    <title>Academic Officer Log In - Stanford High School</title>
            ...
            <div class="col-8 box mx-auto rounded-3">
                <div class="row my-5">
                    ...
                    <div class="col-6" id="logIn">
                        <div class="col-10 text-white title">Log in as an academic officer<hr></div>
                        ...
                        <div class="row my-3">
                            ...
                            <div class="col-10 text-center mt-5">
                                <a href="#" class="col-6 btn btn-secondary">Log In</a>
                            </div>
                    ...
                    <div class="col-6 d-none" id="signIn">
                        <div class="col-10 text-white title">Sign in as an academic officer<hr></div>
