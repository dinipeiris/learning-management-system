...
<head>
    ...
    <title>Admin Log In - Stanford High School</title>
            ...
            <div class="col-8 box mx-auto rounded-3">
                <div class="row my-5">
                    ...
                    <div class="col-6" id="logIn">
                        <div class="col-8 text-white title">Log in as an admin<hr></div>
                    ...
                    <div class="col-6 d-none" id="signIn">
                        <div class="col-8 text-white title">Sign in as an admin<hr></div>
