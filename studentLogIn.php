...
<head>
    ...
    <title>Student Log In - Stanford High School</title>
            ...
            <div class="col-8 box mx-auto rounded-3">
                <div class="row my-5">
                    ...
                    <div class="col-6" id="logIn">
                        <div class="col-8 text-white title">Log in as a student<hr></div>
                        ...
                        <div class="row my-3">
                            ...
                            <div class="col-10 text-center mt-5">
                                <a href="studentHome.php" class="col-6 btn btn-secondary">Log In</a>
                            </div>
                    ...
                    <div class="col-6 d-none" id="signIn">
                        <div class="col-8 text-white title">Sign in as a student<hr></div>
                        ...
                        <div class="col-11 form-floating my-3">
                            ...
                            <label for="email" class="form-label text">Admission Number</label>
                        </div>
                        <div class="d-flex">
                            <div class="col-5 form-floating">
